...
public class Seeder {
    ...
    private void seedProducts() {
        ...
        Product furniture1 = new Product("Sofa", "Comfortable and stylish sofa for your living room", 299.99, category,
                60,
        ...
        Product furniture3 = new Product("Bed Frame", "Sturdy bed frame for a good night's sleep", 1299.99, category,
                250, "https://www.webshop-outlet.nl/wp-content/uploads/2023/10/Adore-Designbed-Beige.jpg");
        Product furniture4 = new Product("Bookshelf", "Organize your books with this spacious bookshelf", 138.00,
                category, 50,
                "https://images-cdn.ubuy.co.in/634005ced6d2d86e2476d69d-artswish-tree-bookshelf-5-shelf-floor.jpg");
        Product furniture5 = new Product("Coffee Table", "Modern coffee table for your living room", 110.99, category,
        ...
        Product furniture8 = new Product("TV Stand", "Sleek TV stand to complement your entertainment setup", 571.00,
                category, 139,
                "https://images-cdn.ubuy.co.in/634e414b3cd45951796ab09c-modern-tv-stand-entertainment-center.jpg");
        Product furniture9 = new Product("Wardrobe", "Spacious wardrobe for storing clothes", 249.99, category, 0,
                "https://www.ikea.com/nl/en/images/products/hauga-wardrobe-with-sliding-doors-white__0931942_pe791324_s5.jpg");
        Product furniture10 = new Product("Side Table", "Compact side table for your bedroom or living room", 275.00,
                category, 65,
    ...
    private void seedUser() {
        ...
        customUser.setAdress("Perenstraat 96");
